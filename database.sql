...
--
-- Vært: mariadb
-- Genereringstid: 31. 07 2020 kl. 16:10:34
-- Serverversion: 10.4.13-MariaDB-1:10.4.13+maria~focal
-- PHP-version: 7.4.6
...
--
-- Struktur-dump for tabellen `cardealer_vehicles`
--
...
--
-- Struktur-dump for tabellen `rented_vehicles`
--
...
--
-- Struktur-dump for tabellen `user_contacts`
--
...
--
-- Struktur-dump for tabellen `user_parkings`
--
...
--
-- Struktur-dump for tabellen `vehicle_sold`
--
...
--
-- Struktur-dump for tabellen `whitelist`
--
...
--
-- Indeks for tabel `cardealer_vehicles`
--
...
--
-- Indeks for tabel `rented_vehicles`
--
...
--
-- Indeks for tabel `user_contacts`
--
...
--
-- Indeks for tabel `user_parkings`
--
...
--
-- Tilføj AUTO_INCREMENT i tabel `cardealer_vehicles`
--
ALTER TABLE `cardealer_vehicles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tilføj AUTO_INCREMENT i tabel `user_contacts`
--
ALTER TABLE `user_contacts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tilføj AUTO_INCREMENT i tabel `user_parkings`
--
ALTER TABLE `user_parkings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
